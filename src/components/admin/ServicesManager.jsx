...
import { Pencil, Loader2, Image as ImageIcon, ExternalLink } from "lucide-react";
        ...
        try {
            ...
            if (error) {
                if (error.code === "PGRST116" || error.message.includes("does not exist")) {
                    toast.error("Table 'services_data' not found.");
                    return;
                }
                throw error;
            }
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">Update service descriptions and images</p>
                </div>
            </div>
